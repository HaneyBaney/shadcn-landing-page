...
const PLATFORMS: PlatformData[] = [
  ...
  },
  {
    ...
    costs: [
      { action: "1 image", tokens: "Chips", dollars: "Varies", type: "dollars" },
      { action: "1 voice message", tokens: "Chips", dollars: "Varies", type: "dollars" },
      { action: "1 video clip", tokens: "Chips", dollars: "Varies", type: "dollars" },
    ],
    topup: "600 chips/mo shared across media. $19.99/mo ($7.80/mo annual). Additional chips can be purchased.",
    url: "https://t.vlmai-1.com/389267/10224/0?aff_sub5=SF_006OG000004lmDN",
    logo: "/logos/lovescape.png",
    domain: "lovescape.com",
  },
  {
    id: "nectar",
    name: "Nectar AI",
