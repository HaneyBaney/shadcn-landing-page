...
export const platforms: Record<string, Platform> = {
  ...
  "lovescape": {
    ...
    features: { chat: 4, video: 4, voice: 4, memory: 3, images: 4 },
    freeTier: false,
    bestFor: "Unlimited chat + characters, 600 chips/mo for media",
    tagline: "Unlimited chat, 600 chips/mo, character publishing",
    priority: "medium",
  },
  "secrets-ai": {
    id: "secrets-ai",
