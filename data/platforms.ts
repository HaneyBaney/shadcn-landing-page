...
export const platforms: PlatformData[] = [
  {
    meta: {
      ...
      websiteUrl: "https://secretdesires.ai",
      badge: "Chat-Focused",
      description: "Unlimited base chat, while images and voice use hearts.",
      bestFor: ["Chat-heavy users", "Low entry price", "Guided scenarios"],
      notIdealFor: ["Heavy media use", "Users wanting included video"],
      highlights: ["Unlimited base chat", "Low price", "Guided scenarios"],
    },
    pricing: {
      monthly: 7.99,
      yearlyMonthly: 7.99,
