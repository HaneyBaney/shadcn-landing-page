...
const RAW: IndexEntry[] = [
  ...
  },
  {
    ...
    momentum: 50,
    features: [
      { key: "chat", label: "Chat", access: "unlimited", detail: "unlimited roleplay" },
      { key: "images", label: "Image Gen", access: "coins", detail: "600 chips/mo" },
      { key: "video", label: "Video Gen", access: "coins", detail: "600 chips/mo" },
      { key: "voice", label: "Voice", access: "coins", detail: "600 chips/mo" },
      { key: "characters", label: "Characters", access: "unlimited" },
      { key: "memory", label: "Memory", access: "limited", detail: "standard" },
    ],
    news: "Premium $19.99/mo (or $7.80/mo annual). 600 chips/mo for images, video, voice. Unlimited chat + characters. NSFW mode included.",
    newsType: "new",
    checked: "May 6, 2026",
    coinNote: "600 chips/mo shared across images, video, and voice generation. Additional chips can be purchased. 15% referral earnings.",
  },
  {
    id: "nectar-ai",
    prevRank: 0,
    ...
    momentum: 35,
    features: [
      { key: "chat", label: "Chat", access: "limited", detail: "6,000/mo" },
      { key: "images", label: "Image Gen", access: "limited", detail: "100/day" },
      { key: "video", label: "Video Gen", access: "coins", detail: "credits" },
      { key: "voice", label: "Voice", access: "limited", detail: "50 min/mo" },
      { key: "characters", label: "Characters", access: "unlimited" },
      { key: "memory", label: "Memory", access: "limited", detail: "basic" },
    ],
